...
interface BreakingChange {
    type: 'api_signature' | 'removed_export' | 'behavior_change' | 'deprecated';
    file: string;
    line: number;
    description: string;
 ...
 */
function detectSignatureChanges(filename: string, patch: string): BreakingChange[] {
 ...
 */
function detectRemovedExports(filename: string, patch: string): BreakingChange[] {
    const changes: BreakingChange[] = [];
    const lines = patch.split('\n');
 ...
 */
function detectBehaviorChanges(filename: string, patch: string): BreakingChange[] {
    const changes: BreakingChange[] = [];
