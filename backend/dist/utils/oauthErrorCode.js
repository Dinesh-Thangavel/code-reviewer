...
exports.oauthCallbackErrorCode = oauthCallbackErrorCode;
/**
...
function oauthCallbackErrorCode(error) {
    ...
    if (lower.includes('incorrect_client_credentials') ||
    ...
    if (lower.includes('github oauth credentials not configured') ||
