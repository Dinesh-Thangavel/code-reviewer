...
exports.getRulesForLanguage = exports.reviewRules = void 0;
exports.reviewRules = {
    'typescript': [
...
const getRulesForLanguage = (language) => {
    return exports.reviewRules[language] || exports.reviewRules['default'];
};
exports.getRulesForLanguage = getRulesForLanguage;
