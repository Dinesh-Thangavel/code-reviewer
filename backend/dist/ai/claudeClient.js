...
exports.CLAUDE_MODEL_NAME = exports.getClaudeModelName = void 0;
...
async function claudeChat(messages, options) {
    ...
    try {
        ...
        const response = await axios_1.default.post(ANTHROPIC_API_URL, requestBody, {
...
async function checkClaudeHealth() {
    ...
    try {
        ...
        await axios_1.default.post(ANTHROPIC_API_URL, testRequest, {
            timeout: 10000,
            headers: {
                'Content-Type': 'application/json',
                'x-api-key': ANTHROPIC_API_KEY,
...
const getClaudeModelName = () => getClaudeModel();
exports.getClaudeModelName = getClaudeModelName;
exports.CLAUDE_MODEL_NAME = getClaudeModel(); // For backward compatibility
