...
exports.buildChatPrompt = exports.buildSummaryPrompt = exports.buildEnhancedReviewPrompt = void 0;
const buildEnhancedReviewPrompt = (filePatch, language, rules, context) => {
...
exports.buildEnhancedReviewPrompt = buildEnhancedReviewPrompt;
/**
 * Build prompt for generating PR summary with visual insights
 */
const buildSummaryPrompt = (allIssues, filesChanged, riskLevel) => {
 ...
 */
const buildChatPrompt = (userQuestion, prContext) => {
    return `
