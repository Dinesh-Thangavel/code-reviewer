...
exports.generateSecurityReport = exports.scanPythonDependencies = exports.scanNpmDependencies = void 0;
/**
 * Scan npm/package.json dependencies
 */
const scanNpmDependencies = async (packageJson) => {
...
exports.scanNpmDependencies = scanNpmDependencies;
/**
 * Check package vulnerability using npm audit API
 */
async function checkPackageVulnerability(packageName, version) {
    try {
        const vulnerabilities = [];
 ...
 */
const scanPythonDependencies = async (requirements) => {
    const vulnerabilities = [];
...
exports.scanPythonDependencies = scanPythonDependencies;
async function checkPythonPackageVulnerability(packageName, version) {
    try {
        const vulnerabilities = [];
 ...
 */
const generateSecurityReport = (vulnerabilities) => {
