...
exports.generateFileDocstrings = exports.generateDocstring = void 0;
const ollamaClient_1 = require("../ai/ollamaClient");
/**
 * Generate docstring for a function or class
 */
const generateDocstring = async (options) => {
 ...
 */
const generateFileDocstrings = async (fileContent, language, format) => {
    const prompt = `
...
exports.generateFileDocstrings = generateFileDocstrings;
